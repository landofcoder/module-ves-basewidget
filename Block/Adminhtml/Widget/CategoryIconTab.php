 ...
 */
namespace Ves\BaseWidget\Block\Adminhtml\Widget;

class CategoryIconTab extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    ...
    protected function _getCategoryRender()
    {
    	if (!$this->_categoryRender) {
    		$this->_categoryRender = $this->getLayout()->createBlock(
    			'Ves\BaseWidget\Block\Adminhtml\Form\Field\CategoryList',
    			'',
    ...
    //             'Ves\BaseWidget\Block\Adminhtml\Form\Field\AjaxType',
    //             '',
    //             ['data' => ['is_render_to_js_template' => true]]
    //             );
    ...
    protected function _prepareToRender()
    {
        ...
        $this->addColumn(
            'item_icon',
            ['label' => __('Icon File Path'),'style' => 'width:140px']
            );
        $this->addColumn(
            'item_iconclass',
            ['label' => __('Icon Font Class'),'style' => 'width:140px']
            );
        // $this->addColumn(
        //     'ajax_type',
        //     ['label' => __('Ajax'),
