...
class SourceRuleTab extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Widget\Block\BlockInterface
{
   ...
   public function __construct(
    ...
    protected function _construct()
    {
        ...
        $this->addData([
            ...
            'cache_tags' => [\Ves\BaseWidget\Model\Product::CACHE_TAG,
            ], ]);
    }
    ...
    public function getCacheKeyInfo()
    {
        ...
        return [
        'VES_BASEWIDGET_CONDITION_TAB_WIDGET',
    ...
    protected function _beforeToHtml()
    {
        ...
        if($template){
            ...
            $this->setTemplate('widget/product_tabs/sourcetab.phtml');
        }
        $this->_eventManager->dispatch(
            'ves_basewidget_tab_collection',
            ['tab' => $this]
            );
    ...
    public function getProductsBySource($source_key){
        ...
        if($collection && $this->_conditionCollection->count()){
