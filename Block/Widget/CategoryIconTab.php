...
class CategoryIconTab extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Widget\Block\BlockInterface
{
   ...
   public function __construct(
    ...
    protected function _beforeToHtml()
    {
        ...
        if($template){
            ...
            $this->setTemplate('widget/product_tabs/category_icon_tab.phtml');
        }
